...
KNOWN_ENV_KEYS = {
    ...
    "ARVIS_VOICE_ALLOWED_LANGUAGES",
    "ARVIS_VOICE_MIN_RMS",
    "ARVIS_VOICE_MIN_PEAK",
    "ARVIS_VOICE_DEBUG_SAVE_LAST",
    "ARVIS_VOICE_DUCKING_ENABLED",
    "ARVIS_VOICE_DUCK_PERCENT",
    "ARVIS_VOICE_DUCK_RESTORE",
    "ARVIS_BROWSER_DEBUG_SAVE",
    "ARVIS_BROWSER_OBSERVER_HEADFUL",
        ...
        path.write_text(
            "\n".join(
                [
                    ...
                    "",
                    "# Standalone MCP Context Servant (реальні корені зберігай в ignored .env/.env.local):",
